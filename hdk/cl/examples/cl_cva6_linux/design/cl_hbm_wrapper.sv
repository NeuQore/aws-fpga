...
// HBM Wrapper
// - Wraper for HBM IP
// - Implements an MMCM to generate 100MHz and (default) 450MHz clock for HBM.
//   cl_cva6_linux retunes CLKOUT0_DIVIDE_F at impl to ~295 MHz (see build_level_1_cl.tcl).
